...
class DeleteRecipeDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Text(AppLocalizations.of(context)!.prmpt_recdelete, textAlign: TextAlign.center),
      ...
      actions: [
        TextButton.icon(
            ...
            label: Text(AppLocalizations.of(context)!.delete, style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
        TextButton.icon(

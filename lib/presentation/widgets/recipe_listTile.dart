  ...
  Widget get display => Container(
        ...
        child: ExpansionTile(
          ...
          children: [
            ...
            Align(alignment: Alignment.centerLeft, child: Text('${AppLocalizations.of(parentContext)!.ingredients}:', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800))),
            const SizedBox(height: 5),
            Wrap(spacing: 8, children: recipeItem.ingredients.map((element) => Chip(label: Text(element))).toList()),
            const SizedBox(height: 10),
